...
const update_product_variant_dto_1 = require("./dto/update-product_variant.dto");
let ProductVariantsController = class ProductVariantsController {
    ...
    async replaceBatch(productId, productVariants) {
        return await this.productVariantsService.replaceBatch(productId, productVariants);
    }
};
__decorate([
    (0, common_1.Patch)(':id'),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProductVariantsController.prototype, "replaceBatch", null);
ProductVariantsController = __decorate([
...
//# sourceMappingURL=product_variants.controller.js.map